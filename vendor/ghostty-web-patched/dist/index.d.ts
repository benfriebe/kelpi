export declare class CanvasRenderer {
     ...
     */
    private terminalDefaultBackgroundRGB;
    /** The construction `fg_color`, the foreground half of the pair above. */
    private terminalDefaultForegroundRGB;
     ...
     */
    setTerminalDefaultColors(background: number | null, foreground: number | null): void;
    /**
     * Update font size
     */
...
export declare class GhosttyTerminal {
    ...
    private cellPool;
    constructor(exports: GhosttyWasmExports, memory: WebAssembly.Memory, cols?: number, rows?: number, config?: GhosttyTerminalConfig, recreate?: ((cols: number, rows: number) => GhosttyTerminal) | undefined);
    get cols(): number;
    get rows(): number;
...
export declare class InputHandler {
     ...
     */
    constructor(ghostty: Ghostty, container: HTMLElement, onData: (data: string) => void, onBell: () => void, onKey?: (keyEvent: IKeyEvent) => void, customKeyEventHandler?: (event: KeyboardEvent) => boolean, getMode?: (mode: number) => boolean, inputElement?: HTMLTextAreaElement);
    /**
...
export declare class Terminal implements ITerminalCore {
     ...
     */
    private pinViewportAcrossGrowth;
    /**
