  ...
  test: {
    ...
    projects: [
      ...
      },
      {
        ...
        test: {
          name: 'harness',
          include: ['scripts/ui-audit/lib/shared-acceptance.test.mjs', 'scripts/ui-audit/lib/gate-plan-visual.test.mjs', 'scripts/ui-audit/lib/incident-diagnostics-audit.test.mjs', 'scripts/ui-audit/lib/incident-diagnostics-provenance.test.mjs', 'scripts/ui-audit/lib/gate-fixups.test.mjs', 'scripts/ui-audit/lib/incident-diagnostics.test.mjs', 'scripts/ui-audit/lib/acceptance.test.mjs', 'scripts/ui-audit/lib/daemon-owner.test.mjs', 'scripts/ui-audit/lib/desktop-lifecycle.test.mjs', 'scripts/ui-audit/lib/desktop-slot.test.mjs', 'scripts/ui-audit/lib/verify-plan.test.mjs', 'scripts/ui-audit/lib/battery.test.mjs', 'scripts/ui-audit/lib/build-cache.test.mjs', 'scripts/ui-audit/lib/placement.test.mjs', 'scripts/ui-audit/lib/shards.test.mjs', 'scripts/ui-audit/lib/audit-options.test.mjs', 'scripts/ui-audit/lib/web-batch.test.mjs', 'scripts/ui-audit/lib/aim.test.mjs', 'scripts/ui-audit/lib/cli-invocations.test.mjs', 'scripts/ui-audit/lib/cdp.test.mjs', 'scripts/ui-audit/lib/workbench.test.mjs', 'scripts/ui-audit/lib/renderer-errors.test.mjs', 'scripts/ui-audit/lib/driver.test.mjs', 'scripts/ui-audit/lib/scenario-runner.test.mjs'],
        },
      },
    ],
  },
