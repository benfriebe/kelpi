...
function fixture() {
    ...
    const readSelection = vi.fn(async () => 'live owner selection'), write = vi.fn();
    const handle: TerminalPaneHandle = { readSelection, write, selection: () => '', root: () => null,
        dispatchKey: () => true, pasteText: () => true, showKeyboard() {}, hideKeyboard() {}, cellHeight: () => 16, focusedOnScreen: () => true };
    ...
    return { runtime, paneID, workspaceID, readSelection, write, dropText, pasteImage };
}
